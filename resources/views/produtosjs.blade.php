@extends('layouts.app', ["current" => "produtosjs"])
    ...
    <div class="modal" tabindex="-1" role="dialog" id="dlgProdutos">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="form-horizontal" id="formProduto">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="categoriaProdutos" name="categoriaProduto">
                ...
                {{-- GAMBIARRA--}}
                {{-- <div class="modal-footer">
                    <button class="btn btn-primary" onclick="criarProduto()">Salvar</button>
    ...
    <script type="text/javascript">
        ...
        function carregarCategorias() {
            $.getJSON('/api/categorias', function(data) {
                for(i = 0; i < data.length; i++) {
                    ...
                    $('#categoriaProdutos').append(opcao);
                }
            });
        }
        ...
        function criarProduto() {
            prod = {
                ...
                preço: $('#precoProduto').val(),
                estoque: $('#quantidadeProduto').val(),
                categoria_id: $('#categoriaProdutos option:selected').val(),
            };
            console.log(prod);
